                        ...
                        <div class="col-4">
                            <div class="row">
                                ...
                                <div class="col-5 hicon">
                                    <img
                                        src="{{ asset('assets/message.png') }}"
                                        alt="user"
                                    />
                                    <img
                                        src="{{ asset('assets/gear.png') }}"
                                        alt="user"
                                    />
                                    <img
                                        src="{{ asset('assets/user.png') }}"
